<template>
    <div id="colocataire">
            <h1 class="text-4xl text-center font-semibold " v-text="props.appartementSharingTitle"></h1>
            <div>
                ...
                <span v-if="props.dataEmptyAppartementSharing" class="text-lg text-gray-500 text-center  flex justify-center">Auncune annonce n'a été trouvé !</span>
            </div>
...
const props = defineProps<{
    dataSearchPost : [],
    appartementSharingTitle : string,
    dataEmptyAppartementSharing : boolean
}>();
